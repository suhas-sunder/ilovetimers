    ...
    <section className="mx-auto max-w-7xl px-4 pb-12">
      ...
      <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
        ...
        <div className="mt-4 rounded-2xl border border-slate-200 bg-slate-50 p-4 text-sm text-slate-800">
          ...
          <span className="font-semibold text-slate-900">N</span> for current
          time, <span className="font-semibold text-slate-900">C</span> to copy
          AM/PM, <span className="font-semibold text-slate-900">M</span> to copy
          military, <span className="font-semibold text-slate-900">R</span> to
          clear, <span className="font-semibold text-slate-900">F</span> for
          fullscreen, and{" "}
