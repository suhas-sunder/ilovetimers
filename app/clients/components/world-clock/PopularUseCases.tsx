    ...
    <section className="mx-auto max-w-7xl px-4 pb-12">
      ...
      <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
        ...
        <div className="mt-4 rounded-2xl border border-slate-200 bg-slate-50 p-4 text-sm text-slate-800">
          <span className="font-semibold text-slate-900">Tip:</span> Keep one{" "}
          <span className="font-semibold text-slate-900">anchor</span> city
          (your local time or UTC), then add the few cities you coordinate with
          most. Use <span className="font-semibold text-slate-900">T</span> to
          toggle 24-hour time,{" "}
          <span className="font-semibold text-slate-900">S</span> for seconds,{" "}
          <span className="font-semibold text-slate-900">C</span> to copy, and{" "}
