          ...
          <div className="rounded-2xl border border-slate-200 bg-slate-50 p-5">
            ...
            <ol className="mt-3 space-y-2 text-sm leading-relaxed text-slate-700">
              ...
              <li>
                ...
                <span className="font-semibold text-slate-900">Intervals</span>{" "}
        ...
        <details className="group mt-6 rounded-2xl border border-slate-200 bg-slate-50 p-6">
          ...
          <div className="mt-4 grid gap-3 md:grid-cols-2">
            <div className="rounded-xl border border-slate-200 bg-white p-4 text-sm text-slate-700">
              <div className="font-semibold text-slate-900">Random roll</div>
            ...
            <div className="rounded-xl border border-slate-200 bg-white p-4 text-sm text-slate-700">
              <div className="font-semibold text-slate-900">Next preview</div>
              <p className="mt-1 leading-relaxed">
            ...
            <div className="rounded-xl border border-slate-200 bg-white p-4 text-sm text-slate-700">
              <div className="font-semibold text-slate-900">Sound beeps</div>
              <p className="mt-1 leading-relaxed">
