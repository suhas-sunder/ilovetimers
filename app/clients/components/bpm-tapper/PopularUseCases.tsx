    ...
    <section className="mx-auto max-w-7xl px-4 pb-12">
      ...
      <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
        ...
        <div className="mt-4 rounded-2xl border border-slate-200 bg-slate-50 p-4 text-sm text-slate-800">
          <span className="font-semibold text-slate-900">Tip:</span> For
          steadier results, tap at least{" "}
          <span className="font-semibold text-slate-900">6–10 beats</span> and
          lock only once the BPM stops bouncing. If you pause between phrases,
          increase the{" "}
          <span className="font-semibold text-slate-900">Reset</span> time.
        </div>
      </div>
    </section>
  );
