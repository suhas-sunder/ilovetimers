    ...
    <section className="mx-auto max-w-7xl px-4 pb-12">
      ...
      <div className="ilt-surface-card p-5">
        ...
        <div className="mt-4 ilt-surface-muted p-4 text-sm text-[var(--ilt-text-secondary)]">
          <span className="font-semibold text-[var(--ilt-text-primary)]">Tip:</span> Set{" "}
          <span className="font-semibold text-[var(--ilt-text-primary)]">
            Check with X min left
          </span>{" "}
          to <span className="font-semibold text-[var(--ilt-text-primary)]">2</span> for oven or{" "}
          <span className="font-semibold text-[var(--ilt-text-primary)]">1</span> for skillet as
