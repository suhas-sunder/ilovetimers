...
export default [
  ...
  route("author/suhas-sunder", "routes/author.suhas-sunder.tsx"),
  route("contact", "routes/contact.tsx"),
  route("how-ilovetimers-is-made", "routes/how-ilovetimers-is-made.tsx"),
  route("copyright", "routes/copyright.tsx"),
  route("countdown-timer", "routes/countdown-timer.tsx"),
  route("timer-stopwatch", "routes/timer-stopwatch.tsx"),
  route("timer-clock", "routes/timer-clock.tsx"),
  ...
  route("study-stopwatch", "routes/study-stopwatch.tsx"),
  ...
  route("world-clock-with-seconds", "routes/world-clock-with-seconds.tsx"),
  route("world-clock-with-milliseconds", "routes/world-clock-with-milliseconds.tsx"),
  ...
  route("analog-clock-with-second-hand", "routes/analog-clock-with-second-hand.tsx"),
  route("full-screen-analog-clock", "routes/full-screen-analog-clock.tsx"),
  route("smooth-second-hand-clock", "routes/smooth-second-hand-clock.tsx"),
  route("digital-clock", "routes/digital-clock.tsx"),
  route("full-screen-clock", "routes/full-screen-clock.tsx"),
  route("big-digital-clock", "routes/big-digital-clock.tsx"),
  ...
  route("countdown-to-date", "routes/countdown-to-date.tsx"),
  route("new-year-countdown", "routes/new-year-countdown.tsx"),
  route("christmas-countdown", "routes/christmas-countdown.tsx"),
  ...
  route("workdays-calculator", "routes/workdays-calculator.tsx"),
  ...
  route("week-number-calculator", "routes/week-number-calculator.tsx"),
  route("months-between-dates-calculator", "routes/months-between-dates-calculator.tsx"),
  route("weeks-between-dates-calculator", "routes/weeks-between-dates-calculator.tsx"),
  route("birthday-countdown", "routes/birthday-countdown.tsx"),
  route("hours-until-calculator", "routes/hours-until-calculator.tsx"),
  route("time-card-calculator", "routes/time-card-calculator.tsx"),
  route("weekly-timesheet-calculator", "routes/weekly-timesheet-calculator.tsx"),
