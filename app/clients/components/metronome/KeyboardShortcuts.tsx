    ...
    <section className="mx-auto max-w-7xl px-4 pb-12">
      <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
          ...
          <div className="mt-3 grid gap-3 md:grid-cols-2">
            ...
            <div className="rounded-xl border border-slate-200 bg-slate-50 p-3 text-sm text-slate-700">
              ...
              <p className="mt-1 leading-relaxed">
                ...
                <span className="font-semibold text-slate-900">Sub</span> counts
            ...
            <div className="rounded-xl border border-slate-200 bg-slate-50 p-3 text-sm text-slate-700 md:col-span-2">
              <div className="font-semibold text-slate-900">Copy contents</div>
              <p className="mt-1 leading-relaxed">
        ...
        <div className="mt-4 rounded-xl border border-slate-200 bg-slate-50 px-3 py-2 text-sm text-slate-700">
          <strong className="text-slate-900">Related.</strong> Only need BPM
          from tapping?{" "}
