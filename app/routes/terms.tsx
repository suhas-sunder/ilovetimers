      ...
      <main className="flex max-w-[1200px] flex-col gap-8 w-full">
        <section className="flex flex-col gap-5">
          ...
          <p>
            ...
            and iLoveTimers, concerning your access to and use of the Services.
        ...
        <section className="flex flex-col gap-4">
          ...
          <p>
            ...
            please address your request to: admin@ilovetimers.com. If we ever
        ...
        <section className="flex flex-col gap-4">
          ...
          <p>
            ...
            iLoveTimers admin or, in extreme cases, may lead to account
            suspension or termination. If you notice any users abusing this
            policy please contact us at admin@ilovetimers.com and we will
