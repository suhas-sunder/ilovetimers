export default function KeyboardShortcuts() {
  // Classroom Timer supports: Space (start/pause), R (reset), F (fullscreen),
  // + (add 1 min), - (subtract 1 min), Esc (exit fullscreen)
  const rows = [
    { key: "Space", action: "Start / pause" },
    { key: "R", action: "Reset to the current minutes setting" },
    { key: "F", action: "Toggle fullscreen" },
    { key: "+", action: "Add 1 minute" },
    { key: "-", action: "Subtract 1 minute" },
    ...
    <section className="mx-auto max-w-7xl px-4 pb-12">
      <div className="ilt-surface-card p-5">
        ...
        <p className="mt-2 text-[var(--ilt-text-secondary)] leading-relaxed">
          ...
          classroom countdown. Shortcuts won’t trigger when your cursor is
          inside an input.
        </p>
        ...
        <div className="mt-4 grid gap-4 md:grid-cols-2">
          <div className="ilt-surface-muted p-4">
            ...
            <p className="mt-2 text-sm leading-relaxed text-[var(--ilt-text-secondary)]">
              The classroom timer runs on your device and doesn’t require
              sign-in. Core timing happens locally in the browser.
            </p>
          </div>
          ...
          <div className="ilt-surface-muted p-4">
            ...
            <p className="mt-2 text-sm leading-relaxed text-[var(--ilt-text-secondary)]">
              ...
              tap/click empty space in the display area to start or pause.
            </p>
          </div>
          ...
          <div className="ilt-surface-muted p-4">
            ...
            <p className="mt-2 text-sm leading-relaxed text-[var(--ilt-text-secondary)]">
              With Sound enabled, the timer can play final beeps near the end
              and an end chime when time is up. If Sound is off, it stays
              silent.
            </p>
          </div>
          ...
          <div className="ilt-surface-muted p-4">
            <div className="text-sm font-semibold text-[var(--ilt-text-primary)]">
              Quick adjust changes the current countdown
            </div>
            <p className="mt-2 text-sm leading-relaxed text-[var(--ilt-text-secondary)]">
              Using −1 min / +1 min / +5 min (or +/− on the keyboard) updates
              the current countdown without restarting. This is meant for “one
              more minute” decisions mid-activity.
            </p>
          </div>
          ...
          <div className="ilt-surface-muted p-4">
            ...
            <p className="mt-2 text-sm leading-relaxed text-[var(--ilt-text-secondary)]">
              ...
              don’t respond, click the timer card once, then use Space/R/F/+/-.
            </p>
          </div>
        </div>
          ...
          <div className="mt-3 grid gap-3 md:grid-cols-2">
            ...
            <div className="ilt-surface-muted p-3 text-sm text-[var(--ilt-text-secondary)]">
              <div className="font-semibold text-[var(--ilt-text-primary)]">
                Final beeps + end chime
              </div>
              <p className="mt-1 leading-relaxed">
                Final beeps can play during the last 5 seconds of the countdown.
                End chime plays when the timer hits zero (if enabled). If Sound
                is off, no audio will play.
              </p>
            </div>
