      ...
      answer: (
        <div className="grid gap-2">
          <div>
            ...
            <strong className="text-slate-900">S</strong>: seconds ·{" "}
            <strong className="text-slate-900">T</strong>: 12/24 ·{" "}
            <strong className="text-slate-900">D</strong>: date ·{" "}
            <strong className="text-slate-900">Z</strong>: zen ·{" "}
