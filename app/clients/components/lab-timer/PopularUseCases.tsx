    ...
    <section className="space-y-4">
      ...
      <div className="ilt-surface-card p-5">
        ...
        <div className="mt-4 ilt-surface-muted p-4 text-sm text-[var(--ilt-text-secondary)]">
          ...
          <span className="font-semibold text-[var(--ilt-text-primary)]">L</span> for laps,{" "}
          <span className="font-semibold text-[var(--ilt-text-primary)]">C</span> to start/pause
          the countdown, <span className="font-semibold text-[var(--ilt-text-primary)]">T</span>{" "}
          to toggle repeat,{" "}
          <span className="font-semibold text-[var(--ilt-text-primary)]">R</span> to reset both,{" "}
