...
export default [
  ...
  route(
    ...
    "routes/guides.browser-timers-background-tabs.tsx",
  ),
  route(
    "guides/browser-timer-alarm-silent",
    "routes/guides.browser-timer-alarm-silent.tsx",
  ),
  route(
    "guides/how-browser-timers-measure-time",
    "routes/guides.how-browser-timers-measure-time.tsx",
  ),
  route(
    "guides/unix-timestamps-seconds-milliseconds-microseconds",
    "routes/guides.unix-timestamps-seconds-milliseconds-microseconds.tsx",
  ),
  route(
    "guides/daylight-saving-time-zone-conversions",
    "routes/guides.daylight-saving-time-zone-conversions.tsx",
  ),
  route("guides/browser-storage", "routes/guides.browser-storage.tsx"),
