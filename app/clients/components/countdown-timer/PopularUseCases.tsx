  ...
  const scenarios: Scenario[] = [
    {
      ...
      description:
        "Start when the meeting begins, then hit Lap for agenda transitions, speaker changes, or decision moments. Use fullscreen when sharing a screen so everyone can read elapsed time clearly.",
      forWho:
        "Standups, interviews, client calls, workshops, or any meeting where you want visible elapsed time plus quick checkpoint timestamps.",
      notFor:
        "If you need a hard stop countdown or schedule-driven pacing. Use Countdown Timer or Presentation Timer instead.",
      links: [
    ...
    },
    {
      ...
      description:
        "Use Start/Pause to measure true focused time. Pause when interrupted, resume when you’re back. Add laps to mark milestones like “draft done” or “review started.”",
      forWho:
        "Deep work, studying, coding, writing, tutoring, or anything where interruptions happen and you want clean elapsed time.",
      notFor:
        "If you want structured work/rest cycles and automatic breaks. Use Pomodoro Timer, Break Timer, or Focus Session Timer instead.",
      links: [
        { label: "Count Up Timer", href: "/count-up-timer" },
    ...
    },
    {
      ...
      description:
        "Start at the first rep, then press Lap at the end of each set/round to capture splits. Fullscreen keeps the timer readable between efforts.",
      forWho:
      ...
      notFor:
        "If you need programmed intervals (work/rest/rounds). Use HIIT Timer, Tabata Timer, EMOM Timer, or Round Timer instead.",
      links: [
        { label: "Count Up Timer", href: "/count-up-timer" },
    ...
    },
    {
      ...
      description:
        "Use the timer as an on-screen run clock. Hit Lap at key splits (checkpoint reached, segment done) so you can review pacing while keeping the display simple.",
      forWho:
        "Speedruns, rehearsals, drills, mock tests, or practice attempts where you want quick split marking without setup.",
      notFor:
        "If you want a page tailored specifically for speedruns and runs. Use Speedrun Timer instead.",
      links: [
        { label: "Count Up Timer", href: "/count-up-timer" },
    ...
    },
    {
      ...
      forWho:
        "Experiments, classroom demos, training labs, and any process where you need clear elapsed time plus lightweight checkpoints.",
      notFor:
        "If you need to count down for a step (incubation, reaction time). Use Lab Timer or Countdown Timer instead.",
      links: [
        { label: "Count Up Timer", href: "/count-up-timer" },
    ...
    },
    {
      ...
      description:
        "Press F for fullscreen to get big digits. In fullscreen, tap/click the time to start or pause without hunting for buttons. Great for a clean on-screen elapsed clock.",
      forWho:
        "Shared displays, classroom/projector use, or timing across the room where readability matters most.",
      notFor:
        "If you only want big countdown digits. Use Fullscreen Timer instead.",
      links: [
        { label: "Count Up Timer", href: "/count-up-timer" },
