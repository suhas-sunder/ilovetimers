      ...
      <div className="ilt-surface-card p-6">
        ...
        <div className="mt-6 grid gap-4 lg:grid-cols-[1.15fr_0.85fr]">
          <div className="ilt-surface-muted p-5">
            ...
            <ol className="mt-3 space-y-2 text-sm leading-relaxed text-[var(--ilt-text-secondary)]">
              ...
              <li>
                <span className="font-semibold text-[var(--ilt-text-primary)]">3)</span> Track
                your score. Tap +/− for reps and ↑/↓ for rounds, or use the big
                buttons under the timer.
              </li>
              <li>
                <span className="font-semibold text-[var(--ilt-text-primary)]">4)</span> When it
          ...
          <div className="ilt-surface-accent p-5">
            ...
            <ul className="mt-3 list-disc space-y-2 pl-5 text-sm text-[var(--ilt-text-secondary)]">
              ...
              <li>
                <span className="font-semibold text-[var(--ilt-text-primary)]">Is:</span>{" "}
        ...
        <div className="mt-6 grid gap-3 sm:grid-cols-2">
          <div className="ilt-surface-card px-4 py-3 text-sm text-[var(--ilt-text-secondary)]">
            <strong className="text-[var(--ilt-text-primary)]">If you want intervals:</strong>{" "}
            use{" "}
            <a
              className="cursor-pointer font-semibold text-[var(--ilt-text-primary)] hover:underline"
              href={abs("/hiit-timer")}
