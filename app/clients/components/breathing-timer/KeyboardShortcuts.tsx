export default function KeyboardShortcuts() {
  // Break Timer supports: Space (start/pause), R (reset), F (fullscreen),
  // S (toggle sound), L (toggle loop), Esc (exit fullscreen)
  const rows = [
    { key: "Space", action: "Start / pause" },
    { key: "R", action: "Reset to selected minutes" },
    ...
    <section className="mx-auto max-w-7xl px-4 pb-12">
      <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
        ...
        <p className="mt-2 text-slate-700 leading-relaxed">
          Click the timer once, then use the keyboard to control the break
...
/* =========================================================
   4) TRUST + HONESTY (timing, fullscreen, sound, loop, focus)
        ...
        <div className="mt-4 grid gap-4 md:grid-cols-2">
          <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
            ...
            <p className="mt-2 text-sm leading-relaxed text-slate-700">
              The break timer runs on your device and doesn’t require sign-in.
              Nothing is sent anywhere just to run the countdown.
            </p>
          </div>
          ...
          <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
            ...
            <p className="mt-2 text-sm leading-relaxed text-slate-700">
              The timer targets an end moment and updates the remaining time
              from that target. This keeps the countdown consistent even if the
              UI frame rate varies.
            </p>
          </div>
          ...
          <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
            ...
            <p className="mt-2 text-sm leading-relaxed text-slate-700">
              With Sound enabled, you’ll hear a chime at the end. With Final
              beeps enabled, you’ll also hear a short beep once per second
              during the last 5 seconds. If Sound is off, it stays silent.
            </p>
          </div>

          <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
            <div className="text-sm font-semibold text-slate-900">
              Loop is an auto-restart
            </div>
            <p className="mt-2 text-sm leading-relaxed text-slate-700">
              When Loop is on, the timer restarts the same break length
              immediately after reaching zero. Turn Loop off if you want the
              timer to stop at the end.
            </p>
          </div>
          ...
          <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
            ...
            <p className="mt-2 text-sm leading-relaxed text-slate-700">
              Keyboard shortcuts work when the card is focused. If keys don’t
              respond, click the timer card once, then use Space/R/F/S/L.
            </p>
          </div>
        </div>
        ...
        <details className="group mt-4 rounded-2xl border border-slate-200 bg-white p-4">
          <summary className="flex cursor-pointer list-none items-center justify-between gap-3 rounded-xl px-1 py-2 focus:outline-none focus:ring-2 focus:ring-amber-300/60">
            <div className="min-w-0">
              <div className="text-sm font-semibold text-slate-900">
                Technical notes (countdown + sound)
              </div>
              <div className="mt-1 text-xs font-medium text-slate-600">
                End-time tracking, last-seconds beeps, and fullscreen handling
              </div>
            </div>
          ...
          <div className="mt-3 grid gap-3 md:grid-cols-2">
            ...
            <div className="rounded-xl border border-slate-200 bg-slate-50 p-3 text-sm text-slate-700">
              ...
              <p className="mt-1 leading-relaxed">
                When enabled, a short beep plays once per second in the last 5
                seconds. A two-tone chime plays at zero. Beeps are suppressed
                when Sound is off.
              </p>
            </div>
            ...
            <div className="rounded-xl border border-slate-200 bg-slate-50 p-3 text-sm text-slate-700">
              ...
              <p className="mt-1 leading-relaxed">
                Loop restarts immediately by setting a new end timestamp for the
                selected minutes, without requiring an extra click.
              </p>
            </div>
