          ...
          <div className="grid gap-3 md:grid-cols-4">
            <div className="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm">
              ...
              <p className="mt-2 text-sm leading-relaxed text-slate-700">
                Set <span className="font-semibold text-slate-900">From</span>{" "}
                and <span className="font-semibold text-slate-900">To</span>{" "}
            ...
            <div className="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm">
              ...
              <p className="mt-2 text-sm leading-relaxed text-slate-700">
                The result shows{" "}
                <span className="font-semibold text-slate-900">From</span> and{" "}
                <span className="font-semibold text-slate-900">To</span> times
          ...
          <div className="mt-4 grid gap-4 md:grid-cols-2">
            ...
            <div className="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm">
              ...
              <p className="mt-2 text-sm leading-relaxed text-slate-700">
                ...
                at <span className="font-semibold text-slate-900">09:30</span>{" "}
                Toronto time.
              </p>
              ...
              <div className="mt-3 grid gap-2 text-sm">
                ...
                <div className="rounded-xl border border-slate-200 bg-slate-50 p-3">
                  ...
                  <div className="mt-1 text-slate-700">
                    Press{" "}
                    <span className="font-semibold text-slate-900">S</span> to
            ...
            <div className="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm">
              ...
              <p className="mt-2 text-sm leading-relaxed text-slate-700">
                ...
                at <span className="font-semibold text-slate-900">17:00</span>{" "}
              ...
              <div className="mt-3 grid gap-2 text-sm">
                <div className="rounded-xl border border-slate-200 bg-slate-50 p-3">
                  ...
                  <div className="mt-1 text-slate-700">
                    ...
                    · Time:{" "}
                    <span className="font-semibold text-slate-900">17:00</span>
                  </div>
                </div>
            ...
            <div className="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm">
              ...
              <p className="mt-2 text-sm leading-relaxed text-slate-700">
                ...
                at <span className="font-semibold text-slate-900">18:20</span>{" "}
