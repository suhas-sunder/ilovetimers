        ...
        <details className="group" open>
          ...
          <div className="mt-3 grid gap-3 sm:grid-cols-2 group-open:grid">
            <div className="rounded-xl border border-slate-200 bg-slate-50 p-4 text-sm text-slate-700">
              <strong className="text-slate-900">Rounds (minutes).</strong>{" "}
              Choose how many minutes the EMOM runs. Each minute is one round.
            </div>

            <div className="rounded-xl border border-slate-200 bg-slate-50 p-4 text-sm text-slate-700">
              <strong className="text-slate-900">Prep countdown.</strong>{" "}
              Optional 0–60s lead-in so you can set up before the first minute
              starts.
            </div>

            <div className="rounded-xl border border-slate-200 bg-slate-50 p-4 text-sm text-slate-700">
              <strong className="text-slate-900">Sound cues.</strong> Optional
              audible cue at each new minute. Turn it off for a silent gym or
              shared space.
            </div>

            <div className="rounded-xl border border-slate-200 bg-slate-50 p-4 text-sm text-slate-700">
              <strong className="text-slate-900">Final beeps.</strong> Optional
          ...
          <div className="mt-4 rounded-xl border border-slate-200 bg-white p-4">
            ...
            <ol className="mt-3 grid gap-2 text-sm text-slate-700 sm:grid-cols-3">
              <li className="rounded-lg border border-slate-200 bg-slate-50 p-3">
                <strong className="text-slate-900">1) Set rounds</strong>: pick
              ...
              <li className="rounded-lg border border-slate-200 bg-slate-50 p-3">
                <strong className="text-slate-900">3) Press Start</strong>: work
          ...
          <div className="mt-4 grid gap-3 sm:grid-cols-2">
            <div className="rounded-xl border border-slate-200 bg-white p-4">
              ...
              <ul className="mt-3 grid gap-2 text-sm text-slate-700">
                <li className="rounded-lg border border-slate-200 bg-slate-50 p-3">
                  <strong className="text-slate-900">Group EMOMs</strong>: go
                  fullscreen so everyone can see the same minute countdown.
                </li>
                <li className="rounded-lg border border-slate-200 bg-slate-50 p-3">
                  <strong className="text-slate-900">No-math pacing</strong>:
                  use the minute beeps as your “start next round” signal.
                </li>
                <li className="rounded-lg border border-slate-200 bg-slate-50 p-3">
                  <strong className="text-slate-900">Quiet environment</strong>:
          ...
          <div className="mt-4 rounded-xl border border-slate-200 bg-slate-50 p-4 text-sm text-slate-700">
            <strong className="text-slate-900">Note.</strong> EMOMs start a new
