          ...
          <div className="mt-3 grid gap-3 md:grid-cols-2">
            <div className="ilt-surface-muted p-3 text-sm text-[var(--ilt-text-secondary)]">
              ...
              <p className="mt-1 leading-relaxed">
                ...
                (0–59). Hours use{" "}
                <span className="font-semibold text-[var(--ilt-text-primary)]">7 bits</span> so
                the display stays valid up to{" "}
                <span className="font-semibold text-[var(--ilt-text-primary)]">99 hours</span>.
              </p>
            </div>

            <div className="ilt-surface-muted p-3 text-sm text-[var(--ilt-text-secondary)]">
              <div className="font-semibold text-[var(--ilt-text-primary)]">Weights</div>
              <p className="mt-1 leading-relaxed">
            ...
            <div className="ilt-surface-muted p-3 text-sm text-[var(--ilt-text-secondary)]">
              <div className="font-semibold text-[var(--ilt-text-primary)]">Rounding</div>
              <p className="mt-1 leading-relaxed">
            ...
            <div className="ilt-surface-muted p-3 text-sm text-[var(--ilt-text-secondary)] md:col-span-2">
              <div className="font-semibold text-[var(--ilt-text-primary)]">Alarm behavior</div>
              <p className="mt-1 leading-relaxed">
